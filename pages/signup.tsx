    ...
    <Box bg="#050017" pt={["166px","200px","200px","200px","200px" ]} pb={["110px","400px","400px","40px","120px"]}>
      ...
      flexDirection={'column'} alignItems={'center'} gap="20px">
           ...
           <Box display={'flex'} border={'1px solid white'} borderRadius="5px"
            w={["60%","50%","45%","22%"]} pl="10px"> <Image  src="/utils/common/email2.svg" alt="pborbit_logo" /><Input color="white" border={'none'} placeholder="Enter Address"/></Box>
            ...
            <Box display={'flex'} border={'1px solid white'} borderRadius="5px"
            w={["60%","50%","45%","22%"]} pl="10px" pr="10px"> <Image  src="/utils/common/password.svg" alt="pborbit_logo" /><Input color="white" border={'none'} placeholder="Enter Address"/><Image  src="/utils/common/hide-2.svg" alt="pborbit_logo" /></Box>

            <Button mt="15px" bg="#00E276" color="white" w={["60%","50%","45%","22%"]}>Sign Up</Button>

            <Text mt="30px"color="white">Already have an account? Signin</Text>
