...
return (
        <Box pt={["100px","220px","200px","320px"]} w="50%" ml={["40px","90px","30px"]}>
        <Text color={"green"} fontSize={["15px","30px","30px","30px"]}>
          We are pborbit
        </Text>
        <Heading fontSize={["15px","30px","30px","40px"]} pr={["10px","10px","10px","150px"]}>
          Court reservation platform for private community, parks, and HOAs
        </Heading>
        <Text fontSize={["10px","30px","30px","30px"]}>
